    ...
    public partial class First : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.Venue_Id, t.City_Id })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.VenueCities", "City_Id", "dbo.Cities");
            DropForeignKey("dbo.VenueCities", "Venue_Id", "dbo.Venues");
            DropIndex("dbo.VenueCities", new[] { "City_Id" });
            DropIndex("dbo.VenueCities", new[] { "Venue_Id" });
